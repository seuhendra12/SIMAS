...
<div class="d-flex flex-column flex-root bg-secondary" id="kt_app_root">
	<div class="d-flex flex-column flex-lg-row flex-column-fluid">
		...
		<div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2"style="background-image: url('{!! asset("/img/background/background-login.png") !!}')">
		</div>
	</div>
@endsection