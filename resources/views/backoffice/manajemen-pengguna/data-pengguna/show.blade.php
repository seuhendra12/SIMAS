          ...
          <div class="col-xxl-6">
            <div class="card card-flush h-md-100">
              <div class="card-body d-flex flex-column justify-content-between bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                  <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Detail Data Pengguna</h1>
                </div>
                <hr>
                <div class="container">
                  <div class="row">
                    ...
                    <div class="col-7">
                      <div class="row">
                        ...
                        <div class="col-8">
                          <h4 class="fw-bold">: {{$user->profile->alamat}} RT {{$user->profile->rt->name}} / RW {{$user->profile->rw->name}}</h4>
                        </div>
                        <div class="col-4">
                          <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
