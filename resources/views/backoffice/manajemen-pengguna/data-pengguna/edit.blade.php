          ...
          <div class="col-xxl-6">
            <div class="card card-flush h-md-100">
              <div class="card-body d-flex flex-column justify-content-between bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                  <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Ubah Data Pengguna</h1>
                </div>
                <hr>
                <div>
                  <!-- NOTIFIKASI ERROR -->
                  ...
                  <form class="form" action="/data-pengguna/{{$user->id}}" method="POST">
                    ...
                    <div class="d-flex flex-column mb-3 fv-row">
                      ...
                      <input type="text" class="form-control" placeholder="Masukkan Nama Lengkap" name="name" value="{{ old('name', $user->name) }}" />
                    </div>
                    <div class="d-flex flex-column mb-3 fv-row">
                      <div class="row">
                        <div class="col-6">
                          ...
                          <input type="text" class="form-control" placeholder="Masukkan Tempat Lahir" name="tempat_lahir" value="{{ old('tempat_lahir', $user->profile->tempat_lahir) }}" />
                        </div>
                        <div class="col-6">
                          <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                            <span class="required">Tanggal Lahir</span>
                          </label>
                          <input type="date" class="form-control" placeholder="Masukkan Tempat Lahir" name="tanggal_lahir" value="{{ old('tanggal_lahir', $user->profile->tanggal_lahir) }}" />
                        </div>
                      </div>
                    </div>
                    <div class="g-9 mb-3">
                    ...
                    <div class="d-flex flex-column mb-3 fv-row">
                      ...
                      <textarea name="alamat" id="alamat" cols="10" rows="2" class="form-control" placeholder="Tambahkan Alamat">{{ old('alamat', $user->profile->alamat) }}</textarea>
                    </div>
                    <div class="d-flex flex-column mb-3 fv-row">
                      <div class="row">
                        <div class="col-2">
                    ...
                    <div class="d-flex flex-column mb-3 fv-row">
                      ...
                      <input type="password" class="form-password" placeholder="Minimal 8 karakter" name="password" value="" />
                    </div>
                    <div class="row">
