                    ...
                    <table class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="sampah-dimanfaatkan/{{$sampahDimanfaatkan->id}}/edit" class="btn btn-yellow btn-sm">
                              <span>
                            ...
                            <a href="#" class="btn btn-red btn-sm" data-bs-toggle="modal" data-bs-target="#confirm-delete-modal" data-sampah-dimanfaatkan-id="{{ $sampahDimanfaatkan->id }}">
                              <span>
