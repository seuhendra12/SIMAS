...
@section('title','Data Sampah Dimanfaatkan')
@section('container')
                  ...
                  <div class="col-8">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                      ...
                      <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        <li class="breadcrumb-item text-muted">
                          <p class="text-muted text-hover-primary">Data Sampah Dimanfaatkan Pada Sistem Informasi Manajemen Sampah (SIMAS) Kelurahan Koto Luar</p>
                        </li>
                      </ul>
                    </div>
                  </div>
                        ...
                        <table class="table table-bordered table-striped text-center">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                <a href="sampah-dimanfaatkan/{{$sampahDimanfaatkan->id}}/edit" class="btn btn-yellow btn-sm button-action" title="Edit" data-bs-toggle="tooltip">
                                  <span>
                                ...
                                <a href="#" class="btn btn-red btn-sm button-action" data-bs-toggle="modal" data-bs-target="#confirm-delete-modal" data-sampah-dimanfaatkan-id="{{ $sampahDimanfaatkan->id }}">
                                  <span>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="confirm-delete-modal-label">Hapus Data Sampah Dimanfaatkan</h5>
    ...
    <script>
      $(document).ready(function() {
        $("#confirm-delete-modal").on("show.bs.modal", function(e) {
          var sampahDimanfaatkanId = $(e.relatedTarget).data("sampah-dimanfaatkan-id");
          console.log(sampahDimanfaatkanId);
          $("#delete-form").attr("action", "{{ url('sampah-dimanfaatkan') }}" + "/" + sampahDimanfaatkanId);
        });
      });
    </script>
