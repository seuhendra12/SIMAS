...
@section('title','Data Sampah Diolah Eksternal')
@section('container')
                ...
                <div class="row">
                  <div class="col-8">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                      ...
                      <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        <li class="breadcrumb-item text-muted">
                          <p class="text-muted text-hover-primary">Data Sampah Diolah Eksternal Pada Sistem Informasi Manajemen Sampah (SIMAS) Kelurahan Koto Luar</p>
                        </li>
                      </ul>
                    </div>
                  </div>
                  <div class="col-4">
                    <div class="d-grid d-md-flex justify-content-md-end">
                      <a href="sampah-diolah-eksternal/create" class="btn btn-sm fw-bold btn-primary">
                  ...
                  <div class="mt-3">
                    <div class="row">
                      ...
                      <div class="col-6 d-grid d-md-flex justify-content-md-end mb-3">
                        <form class="form" action="/sampah-diolah-eksternal">
                      ...
                      <table class="table table-bordered table-striped text-center">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="sampah-diolah-eksternal/{{$sampahDiolahEksternal->id}}/edit" class="btn btn-yellow btn-sm button-action" title="Edit" data-bs-toggle="tooltip">
                                <span>
                              ...
                              <a href="#" class="btn btn-red btn-sm button-action" data-bs-toggle="modal" data-bs-target="#confirm-delete-modal" data-sampah-diolah-eksternal-id="{{ $sampahDiolahEksternal->id }}">
                                <span>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="confirm-delete-modal-label">Hapus Data Sampah Diolah Eksternal</h5>
    ...
    <script>
      $(document).ready(function() {
        $("#confirm-delete-modal").on("show.bs.modal", function(e) {
          var sampahDiolahEksternalId = $(e.relatedTarget).data("sampah-diolah-eksternal-id");
          console.log(sampahDiolahEksternalId);
          $("#delete-form").attr("action", "{{ url('sampah-diolah-eksternal') }}" + "/" + sampahDiolahEksternalId);
        });
      });
    </script>
