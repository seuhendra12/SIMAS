...
@section('title','Tambah Data Sampah Diolah Eksternal')
@section('container')
      ...
      <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
          ...
          <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7">
            ...
            <li class="breadcrumb-item text-muted">Tambah Data Sampah Diolah Eksternal</li>
          </ul>
        </div>
      </div>
    </div>
          ...
          <div class="col-xxl-6">
            <div class="card card-flush h-md-100">
              <div class="card-body d-flex flex-column justify-content-between bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                  <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0 text-center">Form Tambah Data Sampah Diolah Eksternal</h1>
                </div>
                <hr>
                <div>
                  <!-- NOTIFIKASI ERROR -->
                  ...
                  @endif
                  <form class="form" action="{{url('sampah-diolah-eksternal')}}" method="POST">
                    @csrf
