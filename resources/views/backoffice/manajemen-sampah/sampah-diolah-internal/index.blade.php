...
@section('title','Data Sampah Diolah Internal')
@section('container')
...
<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
  <div class="d-flex flex-column flex-column-fluid">
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
      <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
          <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Data Sampah Diolah Internal</h1>
          <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7">
            <li class="breadcrumb-item text-muted">
              <a href="{{url('sampah-diolah-internal')}}" class="text-muted text-hover-primary">Home</a>
            </li>
          </ul>
        </div>
      </div>
          ...
          <div class="col-xxl-6">
            <div class="card card-flush h-md-100">
              <div class="card-body d-flex flex-column justify-content-between bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0">
                <div class="row">
                  <div class="col-8">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                      ...
                      <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        <li class="breadcrumb-item text-muted">
                          <p class="text-muted text-hover-primary">Data Sampah Diolah Internal Pada Sistem Informasi Manajemen Sampah (SIMAS) Kelurahan Koto Luar</p>
                        </li>
                      </ul>
                    </div>
                  </div>
                  <div class="col-4">
                    <div class="d-grid d-md-flex justify-content-md-end">
                      <a href="sampah-diolah-internal/create" class="btn btn-sm fw-bold btn-primary">
                  ...
                  <div class="mt-3">
                    <div class="row">
                      ...
                      <div class="col-6 d-grid d-md-flex justify-content-md-end mb-3">
                        <form class="form" action="/sampah-diolah-internal">
                      ...
                      <table class="table table-bordered table-striped text-center">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="sampah-diolah-internal/{{$sampahDiolahInternal->id}}/edit" class="btn btn-yellow btn-sm button-action" title="Edit" data-bs-toggle="tooltip">
                                <span>
                              ...
                              <a href="#" class="btn btn-red btn-sm" data-bs-toggle="modal" data-bs-target="#confirm-delete-modal" data-sampah-diolah-internal-id="{{ $sampahDiolahInternal->id }}">
                                <span>
                          ...
                          @empty
                          <td colspan="9" class="text-center bg-danger">-- Data Tidak Ada --</td>
                          @endforelse
                        </tbody>
                      </table>
                    </div>
                ...
                <div class="mb-5">
                  {{$sampahDiolahInternals->appends(['perPage' => $perPage])->links('pagination::bootstrap-5')}}
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="confirm-delete-modal-label">Hapus Data Sampah Diolah Internal</h5>
    ...
    <!-- Tambahkan script jQuery dan JavaScript Bootstrap -->
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>

    <!-- Script untuk mengambil ID dan menambahkannya ke dalam formulir -->
    <script>
      $(document).ready(function() {
        $("#confirm-delete-modal").on("show.bs.modal", function(e) {
          var sampahDiolahInternalId = $(e.relatedTarget).data("sampah-diolah-internal-id");
          console.log(sampahDiolahInternalId);
          $("#delete-form").attr("action", "{{ url('sampah-diolah-internal') }}" + "/" + sampahDiolahInternalId);
        });
      });
    </script>
