                ...
                <div>
                  ...
                  <form class="form" action="/kategori-sampah/{{$kategoriSampah->id}}" method="POST">
                    ...
                    <div class="d-flex flex-column mb-3 fv-row">
                      ...
                      <input type="text" class="form-control rounded-0" name="name" value="{{old('name',$kategoriSampah->name)}}" />
                    </div>
                    <div class="d-flex flex-column mb-8 fv-row">
                      <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                        <span class="required">Deskripsi</span>
                      </label>
                      <textarea name="deskripsi" id="deskripsi" cols="10" rows="10" class="form-control rounded-0" placeholder="Tambahkan Deskripsi">{{old('deskripsi',$kategoriSampah->deskripsi)}}</textarea>
                    </div>
                    <div class="mb-10">
