...
@section('title','Tambah Data Kategori Sampah')
@section('container')
      ...
      <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
          ...
          <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7">
            ...
            <li class="breadcrumb-item text-muted">Tambah Data Kategori Sampah</li>
          </ul>
        </div>
      </div>
    </div>
          ...
          <div class="col-xxl-6">
            <div class="card card-flush h-md-100">
              <div class="card-body d-flex flex-column justify-content-between bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                  <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0 text-center">Form Tambah Data Kategori Sampah</h1>
                </div>
                <hr>
                <div>
                  <!-- NOTIFIKASI ERROR -->
                  ...
                  @endif
                  <form class="form" action="{{url('kategori-sampah')}}" method="POST">
                    @csrf
                    <div class="d-flex flex-column mb-3 fv-row">
                      <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                        <span class="required">Kategori Sampah</span>
                      </label>
                      <input type="text" class="form-control rounded-0" placeholder="Masukkan Kategori Sampah" name="name" value="{{old('name')}}" />
                    </div>
                    <div class="d-flex flex-column mb-8 fv-row">
                      <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                        <span class="required">Deskripsi</span>
                      </label>
											<textarea name="deskripsi" id="deskripsi" cols="10" rows="10" class="form-control rounded-0" placeholder="Tambahkan Deskripsi">{{ old('deskripsi') }}</textarea>
                    </div>
                    <div class="mb-10">
