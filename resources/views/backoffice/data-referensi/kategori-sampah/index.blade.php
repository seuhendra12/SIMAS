                ...
                <div class="row">
                  ...
                  <div class="col-4">
                    <div class="d-grid d-md-flex justify-content-md-end">
                      <a href="kategori-sampah/create" class="btn btn-sm fw-bold btn-primary">
                      ...
                      <table class="table table-bordered table-striped text-center">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="kategori-sampah/{{$kategoriSampah->id}}/edit" class="btn btn-yellow btn-sm button-action" title="Edit" data-bs-toggle="tooltip">
                                <span>
                              ...
                              <a href="#" class="btn btn-red btn-sm" data-bs-toggle="modal" data-bs-target="#confirm-delete-modal" data-kategori-sampah-id="{{ $kategoriSampah->id }}">
                                <span>
