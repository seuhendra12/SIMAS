                      ...
                      <table class="table table-bordered table-striped">
                        ...
                        <tbody class="text-center">
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="data-rw/{{$rw->id}}/edit" class="btn btn-yellow btn-sm button-action rounded-0" title="Edit" data-bs-toggle="tooltip">
                                <span>
                              ...
                              <a href="#" class="btn btn-red btn-sm button-action rounded-0" data-bs-toggle="modal" data-bs-target="#confirm-delete-modal" data-rw-id="{{ $rw->id }}">
                                <span>
