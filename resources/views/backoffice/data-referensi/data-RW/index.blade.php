          ...
          <div class="col-xxl-6">
            <div class="card card-flush h-md-100">
              <div class="card-body d-flex flex-column justify-content-between bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0">
                <div class="row">
                  <div class="col-8">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                      ...
                      <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        <li class="breadcrumb-item text-muted">
                          <p class="text-muted text-hover-primary">Data RW Pada Sistem Informasi Manajemen Sampah (SIMAS) Kelurahan Koto Luar</p>
                        </li>
                      </ul>
                    </div>
                  </div>
                  <div class="col-4">
                    <div class="d-grid d-md-flex justify-content-md-end">
                      <a href="data-rw/create" class="btn btn-sm fw-bold btn-primary rounded-0">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                      <div class="modal-content text-center w-50 mx-auto rounded-0 fw-bold">
                        <div class="modal-body text-center">
                          ...
                          {{ Session::get('success') }}
                          <div>
                            <button type="button" class="btn btn-primary mt-2 ronded-0 fw-bold" data-bs-dismiss="modal" aria-label="Close">
                              OK
                            </button>
                          </div>
                        </div>
                  ...
                  <div class="mt-3">
                    <div class="row">
                      ...
                      <div class="col-5 d-grid d-md-flex justify-content-md-end mb-3">
                        <form class="form" action="/data-rw">
                      ...
                      <table class="table table-bordered table-striped">
                        ...
                        <tbody class="text-center">
                          ...
                          <tr>
                            ...
                            <td class="align-middle">RW {{$rw->name}}</td>
                            <td>
                              <a href="data-rw/{{$rw->id}}/edit" class="btn btn-yellow btn-sm button-action rounded-0 fw-bold" title="Edit" data-bs-toggle="tooltip">
                                <span>
                              ...
                              <a href="#" class="btn btn-red btn-sm button-action rounded-0 fw-bold" data-bs-toggle="modal" data-bs-target="#confirm-delete-modal" data-rw-id="{{ $rw->id }}">
                                <span>
                ...
                <div class="mb-5">
                  {{$rws->appends(['perPage' => $perPage])->links('pagination::bootstrap-5')}}
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content rounded-0 fw-bold">
          <div class="modal-header">
            <h5 class="modal-title" id="confirm-delete-modal-label">Hapus Data RW </h5>
          ...
          <div class="modal-body">Apakah kamu yakin ingin menghapus data RW ini ?</div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary rounded-0 fw-bold" data-bs-dismiss="modal">Batal</button>
            <form action="{{ url('data-rw', '__rw_id') }}" method="POST" style="display: inline-block;">
              @csrf
              @method('DELETE')
    ...
    <script>
      $(document).ready(function() {
        $("#confirm-delete-modal").on("show.bs.modal", function(e) {
          var rwId = $(e.relatedTarget).data("rw-id");
          console.log(rwId);
          $(this)
            .find("form")
            .attr("action", function(index, value) {
              return value.replace("__rw_id", rwId);
            });
        });
      });
    </script>
