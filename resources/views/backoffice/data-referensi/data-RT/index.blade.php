                    ...
                    <table class="table table-bordered table-striped">
                      ...
                      <tbody class="text-center">
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="data-rt/{{$rt->id}}/edit" class="btn btn-yellow btn-sm rounded-0 fw-bold" title="Edit" data-bs-toggle="tooltip">
                              <span>
                            ...
                            <a href="#" class="btn btn-red btn-sm rounded-0 fw-bold" data-bs-toggle="modal" data-bs-target="#confirm-delete-modal" data-rt-id="{{ $rt->id }}">
                              <span>
