...
@section('title','Tambah Konversi Poin')
@section('container')
      ...
      <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
          ...
          <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7">
            ...
            <li class="breadcrumb-item text-muted">Tambah Konversi Poin</li>
          </ul>
        </div>
      </div>
    </div>
          ...
          <div class="col-xxl-6">
            <div class="card card-flush h-md-100">
              <div class="card-body d-flex flex-column justify-content-between bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                  <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0 text-center">Form Input Data Konversi Poin</h1>
                </div>
                <hr>
                <div>
                  <!-- NOTIFIKASI ERROR -->
                  ...
                  @endif
                  <form class="form" action="{{url('konversi-poin')}}" method="POST">
                    @csrf
                    <div class="d-flex flex-column mb-3 fv-row">
                      <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                        <span class="required">Angka Konversi</span>
                      </label>
                      <input type="text" class="form-control" placeholder="Masukkan Angka Konversi" name="angka_konversi" />
                    </div>
                    <div class="d-flex flex-column mb-3 fv-row">
                      <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
